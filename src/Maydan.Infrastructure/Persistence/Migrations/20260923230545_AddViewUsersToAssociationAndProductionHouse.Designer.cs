...
namespace Maydan.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923230545_AddViewUsersToAssociationAndProductionHouse")]
    partial class AddViewUsersToAssociationAndProductionHouse
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Maydan.Domain.Entities.Group", b =>
                {
                    ...
                    b.HasIndex("EntityType", "EntityId", "GroupNameAr")
                        .IsUnique();

                    b.HasIndex("EntityType", "EntityId", "GroupNameEn")
                        .IsUnique();
